                ...
                @role('admin')
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <!-- new menu department&company -->
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item {{ Request::is('departments', 'departments/' . Auth::user()->id, 'users/' . Auth::user()->id . '/edit') ? 'active' : null }}" href="{{ url('/departments') }}">
                                {!! trans('titles.adminDepartment') !!}
                            </a>
                            <a class="dropdown-item {{ Request::is('users', 'users/' . Auth::user()->id, 'users/' . Auth::user()->id . '/edit') ? 'active' : null }}" href="{{ url('/users') }}">
                                {!! trans('titles.adminCompany') !!}
                            </a>
                            <!-- END -->
                            <div class="dropdown-divider"></div>
